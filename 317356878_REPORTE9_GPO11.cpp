...
glm::vec3 spotlightPos(2.0f, 0.0f, 2.0f);
glm::vec3 spotlightDir(2.0f, 0.0f, 2.0f);
bool active;
...
glm::vec3 pointLightPositions[] = { //necesita 4 posiciones
...
int main()
{
	...
	Model Burbuja((char*)"Models/Burbuja/Burbuja.obj");
	Model Alga((char*)"Models/Alga/alga.obj");
	Model Sillon((char*)"Models/sillon/Sillon.obj");
	Model Roca1((char*)"Models/roca/roca1.obj");
	Model Roca2((char*)"Models/roca/roca2.obj");
	Model Isla((char*)"Models/Isla/Isla.obj");
	//Model Coral((char*)"Models/Coral/coral.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Directional light (Escenario)
		glUniform3f(glGetUniformLocation(lightingShader.Program, "dirLight.direction"), -0.2f, -1.0f, -0.3f);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "dirLight.ambient"), 0.2f, 0.2f, 0.2f); //iluminar el espacio
		...
		//Alfa
		/*glEnable(GL_BLEND);   //Trabajando con semitransparencias
